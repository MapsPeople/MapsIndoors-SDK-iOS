Pod::Spec.new do |s|
  ...
  s.documentation_url = 'https://docs.mapsindoors.com/sdks-and-frameworks/ios/getting-started'
  ...
  s.source = { http: "https://github.com/MapsPeople/MapsIndoors-SDK-iOS/releases/download/#{s.version.to_s}/MapsIndoorsGoogleMaps.zip" }
  ...
  s.ios.source_files = "GoogleMapsProvider/**/**"
  s.module_name = "MapsIndoorsGoogleMaps"
  s.static_framework = true

  s.dependency 'MapsIndoorsCore', s.version.to_s
  s.dependency 'GoogleMaps', '>= 8.4.0', '<= 9.4.0'
end
