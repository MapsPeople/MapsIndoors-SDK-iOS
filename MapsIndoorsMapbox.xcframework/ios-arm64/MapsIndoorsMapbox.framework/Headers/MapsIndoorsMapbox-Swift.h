...
#ifndef MAPSINDOORSMAPBOX_SWIFT_H
#define MAPSINDOORSMAPBOX_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MapsIndoorsMapbox",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// MARKER_LAYER represents the marker layer, which is a <code>SymbolLayer</code> on which all tiles are rendered
/// POLYGON_FILL_LAYER represents the lines that are typically filled,  it is a <code>FillLayer</code>
/// POLYGON_LINE_LAYER represents the lines that are typically stroked,  it is a <code>LineLayer</code>
/// MODEL_2D_LAYER represents the 2D Models it is a <code>SymbolLayer</code>
/// ACCURACY_CIRCLE_LAYER represents the accuracy circle around the blue dot, it is a <code>CircleLayer</code>
/// BLUEDOT_LAYER represents the blue dot, it is a <code>SymbolLayer</code>
typedef SWIFT_ENUM(NSInteger, MPLayer, open) {
  MPLayerTILE_LAYER = 0,
  MPLayerMARKER_LAYER = 1,
  MPLayerPOLYGON_FILL_LAYER = 2,
  MPLayerPOLYGON_LINE_LAYER = 3,
  MPLayerMODEL_2D_LAYER = 4,
  MPLayerACCURACY_CIRCLE_LAYER = 5,
  MPLayerBLUEDOT_LAYER = 6,
};

@class MapView;
@class NSString;

@interface MPMapConfig (SWIFT_EXTENSION(MapsIndoorsMapbox))
