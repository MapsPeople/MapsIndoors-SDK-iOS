 ...
 */
- (nullable NSObject*)getLiveValueForKey:(NSString*)key domainType:(NSString*)domainType NS_SWIFT_NAME(getLiveValue(forKey:domainType:));

/**
Get a live update based on a known domain type
*/
- (nullable MPLiveUpdate*)getLiveUpdateForDomainType:(NSString*)domainType NS_SWIFT_NAME(getLiveUpdate(forDomainType:));
